 ...
 * @author CH
 */
public class BusInvoker<T> extends AbstractInvoker<T> {
    ...
    public BusInvoker(Class<T> serviceType, URL url, ExchangeClient[] clients) {
        this(serviceType, url, clients, null);
    }

    public BusInvoker(Class<T> serviceType, URL url, ExchangeClient[] clients, Set<Invoker<?>> invokers) {
    ...
    public BusInvoker(Class<T> type, URL url) {
        super(type, url);
    }
