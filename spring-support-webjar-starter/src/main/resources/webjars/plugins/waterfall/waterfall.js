...
;(function( $, window, document, undefined ) {
    ...
    Waterfall.prototype = {
        ...
        _requestData: function(callback) {
			...
			this._handleResponse(options.data, curPage, options.callbacks);
            // update state status
         ...
         * @param {Function} callback
         */
        _handleResponse: function(data, curPage, callback) {
            var self = this,
                options = this.options,
                content = $.trim(options.callbacks.renderData(data, curPage, options.dataType)),
                $content = $(content),
