...
import com.chua.starter.gateway.admin.support.mapper.FieldMapper;
...
public class FieldDTO implements Serializable {
    ...
    public static final class FieldDTOBuilder {
         ...
         * @return FieldDOBuilder
         */
        public FieldDTOBuilder id(final String id) {
            this.id = id;
            return this;
        }
         ...
         * @return FieldDOBuilder
         */
        public FieldDTOBuilder modelId(final String modelId) {
            this.modelId = modelId;
            return this;
        }
         ...
         * @return FieldDOBuilder
         */
        public FieldDTOBuilder selfModelId(final String selfModelId) {
            this.selfModelId = selfModelId;
            return this;
        }
         ...
         * @return FieldDOBuilder
         */
        public FieldDTOBuilder name(final String name) {
            this.name = name;
            return this;
        }
         ...
         * @return FieldDOBuilder
         */
        public FieldDTOBuilder fieldDesc(final String fieldDesc) {
            this.fieldDesc = fieldDesc;
            return this;
        }
         ...
         * @return FieldDOBuilder
         */
        public FieldDTOBuilder required(final Boolean required) {
            this.required = required;
            return this;
        }
         ...
         * @return FieldDOBuilder
         */
        public FieldDTOBuilder ext(final String ext) {
            this.ext = ext;
            return this;
        }
         ...
         */
        public FieldDTOBuilder dateCreated(final Timestamp dateCreated) {
            this.dateCreated = dateCreated;
            return this;
        }
         ...
         * @return FieldDOBuilder
         */
        public FieldDTOBuilder dateUpdated(final Timestamp dateUpdated) {
            this.dateUpdated = dateUpdated;
            return this;
        }
