...
import com.chua.starter.gateway.admin.support.model.entity.FieldDO;
...
public class FieldVO {
    ...
    public static final class FieldVOBuilder {
         ...
         * @return FieldDOBuilder
         */
        public FieldVOBuilder id(final String id) {
            this.id = id;
            return this;
        }
         ...
         * @return FieldDOBuilder
         */
        public FieldVOBuilder modelId(final String modelId) {
            this.modelId = modelId;
            return this;
        }
         ...
         * @return FieldDOBuilder
         */
        public FieldVOBuilder selfModelId(final String selfModelId) {
            this.selfModelId = selfModelId;
            return this;
        }
         ...
         * @return FieldDOBuilder
         */
        public FieldVOBuilder name(final String name) {
            this.name = name;
            return this;
        }
         ...
         * @return FieldDOBuilder
         */
        public FieldVOBuilder fieldDesc(final String fieldDesc) {
            this.fieldDesc = fieldDesc;
            return this;
        }
         ...
         * @return FieldDOBuilder
         */
        public FieldVOBuilder required(final Boolean required) {
            this.required = required;
            return this;
        }
         ...
         * @return FieldDOBuilder
         */
        public FieldVOBuilder ext(final String ext) {
            this.ext = ext;
            return this;
        }
         ...
         */
        public FieldVOBuilder dateCreated(final Timestamp dateCreated) {
            this.dateCreated = dateCreated;
            return this;
        }
         ...
         * @return FieldDOBuilder
         */
        public FieldVOBuilder dateUpdated(final Timestamp dateUpdated) {
            this.dateUpdated = dateUpdated;
            return this;
        }
