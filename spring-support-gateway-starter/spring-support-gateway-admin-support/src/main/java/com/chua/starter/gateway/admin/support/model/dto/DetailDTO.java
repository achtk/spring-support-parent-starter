...
import com.chua.starter.gateway.admin.support.mapper.DetailMapper;
...
public class DetailDTO {
    ...
    public static final class DetailDTOBuilder {
         ...
         */
        public DetailDTOBuilder id(final String id) {
            this.id = id;
            return this;
        }
         ...
         * @return DetailDOBuilder
         */
        public DetailDTOBuilder fieldId(final String fieldId) {
            this.fieldId = fieldId;
            return this;
        }
         ...
         * @return DetailDOBuilder
         */
        public DetailDTOBuilder example(final Boolean example) {
            this.example = example;
            return this;
        }
         ...
         * @return DetailDOBuilder
         */
        public DetailDTOBuilder fieldValue(final String fieldValue) {
            this.fieldValue = fieldValue;
            return this;
        }
         ...
         * @return DetailDOBuilder
         */
        public DetailDTOBuilder valueDesc(final String valueDesc) {
            this.valueDesc = valueDesc;
            return this;
        }
         ...
         * @return DetailDOBuilder
         */
        public DetailDTOBuilder dateCreated(final Timestamp dateCreated) {
            this.dateCreated = dateCreated;
            return this;
        }
         ...
         * @return DetailDOBuilder
         */
        public DetailDTOBuilder dateUpdated(final Timestamp dateUpdated) {
            this.dateUpdated = dateUpdated;
            return this;
        }
