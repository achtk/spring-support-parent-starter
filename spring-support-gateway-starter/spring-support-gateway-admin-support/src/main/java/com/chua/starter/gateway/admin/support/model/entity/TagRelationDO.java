...
import com.chua.starter.gateway.admin.support.model.dto.TagRelationDTO;
...
public final class TagRelationDO extends BaseDO {
    ...
    public static final class TagRelationDOBuilder {
         ...
         */
        public TagRelationDOBuilder id(final String id) {
            this.id = id;
            return this;
        }
         ...
         * @return RuleDOBuilder.
         */
        public TagRelationDOBuilder dateCreated(final Timestamp dateCreated) {
         ...
         * @return RuleDOBuilder.
         */
        public TagRelationDOBuilder dateUpdated(final Timestamp dateUpdated) {
         ...
         * @return TagDOBuilder.
         */
        public TagRelationDOBuilder tagId(final String tagId) {
            this.tagId = tagId;
            return this;
        }
         ...
         * @return TagRelationDO.
         */
        public TagRelationDOBuilder apiId(final String apiId) {
            this.apiId = apiId;
            return this;
        }
