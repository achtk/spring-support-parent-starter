...
public class ModelDO extends BaseDO {
    ...
    public static final class ModelDOBuilder {
         ...
         */
        public ModelDOBuilder id(final String id) {
            this.id = id;
            return this;
        }
         ...
         * @return ModelDOBuilder
         */
        public ModelDOBuilder name(final String name) {
            this.name = name;
            return this;
        }
         ...
         * @return ModelDOBuilder
         */
        public ModelDOBuilder modelDesc(final String modelDesc) {
            this.modelDesc = modelDesc;
            return this;
        }
         ...
         * @return ModelDOBuilder
         */
        public ModelDOBuilder dateCreated(final Timestamp dateCreated) {
         ...
         * @return ModelDOBuilder
         */
        public ModelDOBuilder dateUpdated(final Timestamp dateUpdated) {
