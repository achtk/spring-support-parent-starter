...
@EnableScheduling
@SolonMain
public class NginxWebUIApplication {
	static Logger logger = LoggerFactory.getLogger(NginxWebUIApplication.class);
	...
	public static void main(String[] args) {
		...
		Solon.start(NginxWebUIApplication.class, args, app -> {
